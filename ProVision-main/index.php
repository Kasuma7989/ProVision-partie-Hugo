...
<?php include_once __DIR__ . '/includes/nav.php'; ?>
    <header>
        ...
        <div class="header-banner">
            ...
            <div>
                <a href="pages/subscription.php" class="btn-subscribe">S'abonner</a>
            </div>
        </div>
    </header>
    <main>
            ...
            <div class="subscribeHome-container">
                <div class="subscribeHome-card">
                    ...
                    <div class="subscribeHome-btn">
                        <a href="pages/subscription.php"><button class="tryYourself" id="standard">
                                Essai Gratuit
                            </button></a>
                    </div>
                </div>
                <div class="subscribeHome-card">
                    ...
                    <div class="subscribeHome-btn">
                        <a href="pages/subscription.php"> <button class="tryYourself" id="premium">
                                Essai Gratuit
                        </button> </a>
                    </div>
                </div>
